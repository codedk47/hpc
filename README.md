...
<pre>
----------------------------------------------------------------------------------------------------
服务端启动 -> 创建最大连接数 socket 并且绑定IOCP事件队列 -> [定时器循环... -> 激活某个任务线程 -> 定时器循环...]
	-> 线程1 初始化 -> [IOCP事件队列... -> 某个 socket 事件 -> 基本判断 -> PHP... -> IOCP事件队列...]
	-> 线程2 初始化 -> [IOCP事件队列... -> 某个 socket 事件 -> 基本判断 -> PHP... -> IOCP事件队列...]
	-> 线程3 初始化 -> [IOCP事件队列... -> 某个 socket 事件 -> 基本判断 -> PHP... -> IOCP事件队列...]
	-> 线程N 初始化 -> [IOCP事件队列... -> 某个 socket 事件 -> 基本判断 -> PHP... -> IOCP事件队列...]
----------------------------------------------------------------------------------------------------
